                    ...
                    <div class="card-body">
                        ...
                        <article class="card">
                            <div class="card-body row">
                                ...
                                <div class="col"> <strong>Tanggal Transaksi:</strong> <br><?= date('d M Y / H:i:s',$data['created']) ?></div>
                                <div class="col"> <strong>Tanggal Update:</strong> <br><?= date('d M Y / H:i:s',$data['updated']) ?> </div>
                            </div>
                        </article>
                        <div class="track">
