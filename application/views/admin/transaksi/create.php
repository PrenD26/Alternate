					...
					<div class="card">
						...
						<div class="card-body">
							<div class="form-group">
								...
								<select name="id_pelanggan" id="id_pelanggan" class="form-control select2 select2-purple" data-dropdown-css-class="select2-purple"  onchange="return autofill();">
									<option selected disabled value="">-- Silahkan Pilih --</option>
									<?php foreach ($pelanggan as $plg) : ?>
										<option value="<?= $plg->id ?>"><?= $plg->kode_pelanggan ?> |
											<?= $plg->nama_pelanggan ?>
										</option>
									<?php endforeach ?>
								</select>
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="form-group">
								<div class="row ">
									<div class="col">
										...
										<input type="text" name="no_transaksi" value="TRS-<?= time() ?>" readonly class="form-control">
									</div>
									<div class="col">
							...
							<div class="form-group">
								...
								<select name="id_paket" id="id_paket" class="form-control select2 select2-purple" data-dropdown-css-class="select2-purple" onchange="return autofill();" >
									<option selected disabled value="">-- Silahkan Pilih --</option>
									<?php foreach ($paket as $pkt) : ?>
										<option value="<?= $pkt->id ?>"><?= $pkt->kode_paket ?> |
											<?= $pkt->nama_paket ?>
										</option>
									<?php endforeach ?>
								</select>
							...
							<div class="form-group">
								<div class="row ">
									<div class="col">
										<label>Harga</label>
										<input type="text" placeholder="Auto" name="biaya" id="harga" onkeyup="jumlahBiaya();" value="" readonly class="form-control">
									</div>
									<div class="col">
							...
							<div class="form-group">
								<div class="row ">
									<div class="col">
										...
										<input type="text" placeholder="Auto" name="status" id="status" value="1" readonly class="form-control">
									</div>
									<div class="col">
								...
								<input type="hidden" name="id_user" value="<?= $this->session->userdata['id'] ?>" readonly class="form-control">
							</div>
		...
		$.ajax({
			...
			success: function(data) {
				...
				$.each(hasil, function(key, val) {
					...
					document.getElementById('id_paket').value = val.id;
		...
		$.ajax({
			...
			success: function(data) {
				...
				$.each(hasil, function(key, val) {
					...
					document.getElementById('id_pelanggan').value = val.id;
					document.getElementById('nama_pelanggan').value = val.nama_pelanggan;
					document.getElementById('nomor_telepon').value = val.nomor_telepon;
