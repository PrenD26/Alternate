  ...
  <div class="section-body">
    <div class="invoice">
        ...
        <div class="row invoice-info">
          ...
          <div class="col-sm-4 invoice-col">
            ...
            <address>
              ...
              No Telepon: <?= $transaksi->nomor_telepon ?><br>
            </address>
          </div>
          <!-- /.col -->
          <div class="col-sm-4 invoice-col">
            ...
            <b>Invoice <?= $transaksi->no_transaksi ?><br>
              <br>
              <b>Tgl Transaksi:</b> <?= date('d M Y / H:i:s',$transaksi->date_created) ?><br>
      ...
      <div class="text-md-right">
        <a href="<?= base_url('transaksi/nota/') . $transaksi->id; ?>" rel="noopener" target="_blank" class="btn btn-primary btn-icon icon-left">
